...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/start/lspsaga.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
  ...
  ["vim-highlightedyank"] = {
    loaded = true,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/start/vim-highlightedyank"
  },
  ["vim-surround"] = {
    loaded = true,
