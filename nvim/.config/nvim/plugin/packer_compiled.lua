...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-emoji', 'cmp-path', 'cmp-vsnip', 'cmp-buffer', 'vim-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'black', 'nvim-comment', 'vim-lua-format', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
