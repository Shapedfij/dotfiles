...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'cmp-buffer', 'cmp-emoji', 'cmp-path', 'cmp-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
