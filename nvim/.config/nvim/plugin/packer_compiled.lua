...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-lua-format', 'nvim-comment', 'black', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'cmp-emoji', 'cmp-path', 'cmp-vsnip', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
