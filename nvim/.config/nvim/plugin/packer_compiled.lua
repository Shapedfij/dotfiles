...
_G.packer_plugins = {
  ...
  ["lua-dev.nvim"] = {
    config = { "\27LJ\2\n7\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\28lsp.servers.sumneko_lua\frequire\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'black', 'gitsigns.nvim', 'nvim-comment', 'vim-lua-format'}, { event = "BufRead *" }, _G.packer_plugins)]]
