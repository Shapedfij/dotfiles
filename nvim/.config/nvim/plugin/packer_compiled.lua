...
_G.packer_plugins = {
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/kaiz/.local/share/nvim/site/pack/packer/start/tokyonight.nvim"
  },
  ["vim-fish"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-lua-format', 'nvim-comment', 'black'}, { event = "BufRead *" }, _G.packer_plugins)]]
